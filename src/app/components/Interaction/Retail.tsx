  ...
  return (
    <div className="flex xs:flex-col-reverse justify-between gap-4 xs:border-[1px] border-gray-300 rounded-xl xs:p-4 xl:p-8  md:border-none items-center relative md:flex-row  ">
        <div  className='xs:mt-16 md:mt-0 w-full'>
            <h2 className="text-2xl font-semibold text-slate-800 mb-4">Retail</h2>
            <p className="text-slate-500 text-sm xs:w-full xl:w-[400px]">Our AI voice agents assist retail accounts by efficiently handling WISMO inquiries, cancellations, <br />
             modifications, and FAQs, ensuring seamless, customer support and satisffaction. They provide
             timely, accurate responses and manage a variety of  customer needs, streamlining operations and  enhancing the overall shopping experience. 
            </p>
        </div>
        <div className='relative w-full'>
        <div className='max-w-[600px] max-h-[600px] '>
             <Image src={retail} alt='real estate' width={600} height={600} className='rounded-lg' />
             </div>
                <div className="hidden xl:flex absolute bg-white top-[-50px] left-[-250px] w-[400px] rounded-lg shadow-lg flex-col gap-6 py-8 px-4">
                   ...
                   <hr />
                   <p className="text-slate-500 text-xs w-[350px]">"Hi <span className='text-blue-500'>{`{name}`}</span>, thank you for calling Island Tee's.  Let me pull up your order.  "</p>
               </div>
