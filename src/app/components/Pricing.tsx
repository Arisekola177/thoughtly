    ...
    <div className="w-full">
         <div className="md:w-10/12 mx-auto w-full flex flex-col items-center justify-center gap-3 xs:mt-10 md:mt-32">
               ...
               <div className="flex flex-col">
                    <p className="text-slate-500 text-center xs:text-[8px] sm:text-[14px] sml:text-sm">10¢ per minute of your Thoughtly Agent talking on <br /> the phone. No hidden vendor fees, just one simple<br /> price.</p>
                    <div className="bg-white w-full sml:w-[350px] rounded-md flex items-center mt-4">
